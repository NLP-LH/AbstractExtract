...
public class TrainOfCrfSvm {
	...
	public static void main(String[] args) throws IOException {
		...
		String TrianDataPath="D:/file/TrainData/TrainData.xls";
		//CRF训练
		ArrayList<String> AbstractCRFString = new ArrayList<String>();
		//从训练数据EXCEL文件夹中将数据提取出来并放入TXT文件中
		ExcelRead ER=new ExcelRead();	
		AbstractCRFString=ER.ExcelReadingGetColumn(TrianDataPath, 1,1107, 1);
		FileInputAndOutput.writetxtFile2(AbstractCRFString,"D:\\file\\Crf\\ManualLabeledabstract.txt");//写入文件中
